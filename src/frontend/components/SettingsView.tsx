...
const TOOL_LABELS: Record<keyof ToolPermissions, string> = {
  ...
  listTeams: 'list-teams — list/find joined Teams',
  listChannels: 'list-channels — list/find visible channels',
  listChannelMessages: 'list-channel-messages — read recent channel posts/replies',
  getChannelMessage: 'get-channel-message — read a channel thread or deep link',
  searchChannelMessages: 'search-channel-messages — search channel posts/replies',
  editChannelMessage: 'edit-channel-message — edit your own channel post/reply',
  deleteChannelMessage: 'delete-channel-message — soft-delete your own channel post/reply',
  ...
  getTeamsImage: 'get-teams-image — view inline images/screenshots in a chat message',
  getAttachment: 'get-attachment — read a Teams/Outlook file attachment (images, PDFs, docs)',
